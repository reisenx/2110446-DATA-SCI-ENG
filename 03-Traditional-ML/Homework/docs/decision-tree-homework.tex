...
\definecolor{ghkeyword}{HTML}{ff7b72} % Pink/Red keywords
\definecolor{ghstring}{HTML}{a5d6ff}  % Light blue strings
\definecolor{ghcomment}{HTML}{8b949e} % Gray comments
\definecolor{ghnumber}{HTML}{6e7681}  % Line number gray
...
\lstset{
    ...
    numberstyle=\tiny\color{ghnumber},
    % Formatting
    breaklines=true,
    captionpos=b,
    keepspaces=true,
...
\begin{document}
    ...
    \section{Data Gathering}
        \subsection{Colab Notebook}
            ...
            \begin{lstlisting}[language=Python, caption=Dependencies, gobble=16]
                import pandas as pd
        ...
        \subsection{Load Data}
            ...
            \begin{lstlisting}[language=Python, caption=Load Dataset, gobble=16]
                KYPHOSIS_URL = "https://raw.githubusercontent.com/reisenx/2110446-DATA-SCI-ENG/refs/heads/main/03-Traditional-ML/Homework/kyphosis.csv"
    ...
    \textbf{Exploratory Data Analysis (EDA)} is the data analysis to identifies general patterns in the data.
        ...
        \subsection{Class Distribution}
            ...
            \begin{lstlisting}[language=Python, caption=Class Distribution, gobble=16]
    ...
    \pagebreak
        ...
        \subsection{Correlation Heatmap}
            ...
            \begin{lstlisting}[language=Python, caption=Correlation Heatmap, gobble=16]
    ...
    \pagebreak
        ...
        \subsection{Pair Plot}
            ...
            \begin{lstlisting}[language=Python, caption=Pair Plot, gobble=16]
    ...
    \section{Data Preparation}
        \subsection{Feature and Target Separation}
            ...
            \begin{lstlisting}[language=Python, caption=Feature and Target Separation, gobble=16]
        ...
        \subsection{Train and Test Dataset}
            ...
            \begin{lstlisting}[language=Python, caption=Train and Test Dataset Separation, gobble=16]
    ...
    \section{Decision Tree}
        \subsection{Adjusting Parameters}
            ...
            \begin{lstlisting}[language=Python, caption=Decision Tree Parameters, gobble=16]
                CRITERION = "gini"
                MAX_DEPTH = 3
    ...
    \pagebreak
        ...
        \subsection{Decision Tree Model}
            ...
            \begin{lstlisting}[language=Python, caption=Decision Tree Visualization, gobble=16]
    ...
    \pagebreak
        ...
        \subsection{Confusion Matrix}
            ...
            \begin{lstlisting}[language=Python, caption=Confusion Matrix of Decision Tree, gobble=16]
    ...
    \pagebreak
        ...
        \subsection{Classification Report}
            ...
            \begin{lstlisting}[language=Python, caption=Classification Report of Decision Tree, gobble=16]
    ...
    \section{Random Forest}
        \subsection{Adjusting Parameters}
            ...
            \begin{lstlisting}[language=Python, caption=Random Forest Model Parameters, gobble=16]
                N_ESTIMATORS = 100
                CRITERION = "gini"
                MAX_DEPTH = 3
                MIN_SAMPLES_SPLIT = 8
    ...
    \pagebreak
        ...
        \subsection{Classification Report}
            ...
            \begin{lstlisting}[language=Python, caption=Classification Report of Random Forest Model, gobble=16]
                report = classification_report(y_test, predictions, digits=4)
                print(report)
            \end{lstlisting}
