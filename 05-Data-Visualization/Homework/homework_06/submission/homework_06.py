...
value = st.sidebar.slider(
    label="Select Number of Clusters", min_value=1, max_value=6, value=3, step=1
)
...
fig_matrix = px.scatter_matrix(
    df, dimensions=feature_names, color="Species", color_discrete_map=colors
)
...
inertias = perform_elbow_analysis(X_scaled, max_clusters=6)
